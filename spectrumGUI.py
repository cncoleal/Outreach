...
def open_popup():
    ...
    shutdown_button_yes.config(width=15, height=5,activebackground="#568156", relief=RAISED, justify='left')
    shutdown_button_yes.place(x=wid/16-30, y=60)
    ...
    shutdown_button_no.config(width=15, height=5, activebackground="#f26161", relief=RAISED, justify='center')
