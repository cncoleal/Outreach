...
class gui(Frame):
	...
	# shutter speed
        ...
        button_takePicture = Button(self, text="Take Picture", borderwidth=4,highlightbackground='#333',bg='#FECD8E', height=10, command=lambda: take_picture(str(e1.get()) + "_raw.jpg", int(e2.get())))
