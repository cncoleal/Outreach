...
def open_popup():
    ...
    Label(top, text="Shutdown Now?", font='Mistral 18 bold').pack(side=TOP)#place(x=wid/8, y=20)
    ...
    shutdown_button_yes.pack(side=BOTTOM)
    ...
    shutdown_button_no.pack(side=BOTTOM)
