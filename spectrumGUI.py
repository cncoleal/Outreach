...
def open_popup():
    ...
    shutdown_button_yes.config(width=20, height=10,activebackground="#568156", relief=RAISED)
    ...
    shutdown_button_no.config(width=20, height=10, activebackground="#f26161", relief=RAISED)
    shutdown_button_no.place(x=wid/16+10+20, y=60)
