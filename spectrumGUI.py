...
class gui(Frame):
	...
	## Buttons ##
        ...
        button_takePicture.grid(row=2, column=0, columnspan=2, padx=10, pady=10, sticky=W+E) 
        button_createSpectrum.grid(row=2, column=2, columnspan=2, padx=10, pady=10, sticky=W+E)
